...
public class AIObserverServletRequestMonitoringFilter extends OncePerRequestFilter {

    private static final String ACTUATOR_PREFIX = "/actuator";

    private final AIObserverWebLatencyCollector latencyCollector;

    public AIObserverServletRequestMonitoringFilter(AIObserverWebLatencyCollector latencyCollector) {

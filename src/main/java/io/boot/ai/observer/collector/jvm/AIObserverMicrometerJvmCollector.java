...
import static io.boot.ai.observer.utils.AIObserverMicrometerMetric.*;

public class AIObserverMicrometerJvmCollector
{
    ...
    public AIObserverMicrometerJvmCollector(MeterRegistry registry) {
    ...
    double gauge(AIObserverMicrometerMetric metric) {

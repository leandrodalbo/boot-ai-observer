...
public class AIObserverCopilotAiClient extends AIObserverClient
{

    private static final String DEFAULT_URL     = "https://api.githubcopilot.com/chat/completions";
    private static final String DEFAULT_MODEL   = "gpt-4o";
    private static final String DEFAULT_VERSION = "2024-10-01-preview";
    ...
    public AIObserverCopilotAiClient(ObjectMapper mapper, AIObserverSerializer serializer, AIObserverProperties props) {

...
class AIObserverReactiveErrorCollectorTest {

    private AIObserverReactiveErrorCollector collector;

    @BeforeEach
    void setUp() {
        collector = new AIObserverReactiveErrorCollector();
    }
    ...
    void track_longMessage_truncatesTo120Chars() {
        ...
        assertThat(messagePart.length()).isLessThanOrEqualTo(121); // 120 chars + ellipsis
    }
    ...
    @Test
    void getAndReset_emptyBuffer_returnsEmptyList() {
        assertThat(collector.getAndReset()).isEmpty();
    }

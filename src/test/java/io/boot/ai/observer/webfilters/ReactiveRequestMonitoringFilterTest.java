...
class ReactiveRequestMonitoringFilterTest {

    @Mock WebLatencyCollector latencyCollector;
    @Mock ErrorCollector   errorCollector;
    @Mock WebFilterChain   chain;

    private ReactiveRequestMonitoringFilter filter;

    @BeforeEach
    void setUp() {
        filter = new ReactiveRequestMonitoringFilter(latencyCollector, errorCollector);
    }
